...
homekit_characteristic_t light_temp = HOMEKIT_CHARACTERISTIC_(COLOR_TEMPERATURE, (float) 50);
...
homekit_characteristic_t alarm_temp = HOMEKIT_CHARACTERISTIC_(COLOR_TEMPERATURE, (float) 50);
...
homekit_accessory_t *accessories[] = {
    HOMEKIT_ACCESSORY(.id=1, .category=homekit_accessory_category_lightbulb, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(NAME, "SoftLightButton"),
            HOMEKIT_CHARACTERISTIC(MANUFACTURER, "Ben"),
            HOMEKIT_CHARACTERISTIC(SERIAL_NUMBER, "0123497"),
